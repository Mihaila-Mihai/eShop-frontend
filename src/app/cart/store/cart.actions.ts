...
import {DeliveryAddress, Item} from "../content/model";
...
export const increaseItemQuantity = createAction('[Cart] Increase Item Quantity', props<{ item: Item }>());
export const decreaseItemQuantity = createAction('[Cart] Decrease Item Quantity', props<{ item: Item }>());
